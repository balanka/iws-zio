...
import com.kabasoft.iws.repository.PostgresTableDescription
...
final class QueryServiceImpl(
  ...
  /** Lateral join
    ...
    */
  override def findAllWithLatestOrder(): ZStream[Any, RepositoryError, CustomerWithOrderDate] = {
  ...
  /** Correlated subqueries in selection
    ...
    */
  override def findAllWithCountOfOrders(): ZStream[Any, RepositoryError, CustomerWithOrderNumber] = {
