...
import com.kabasoft.iws.repository.{FinancialsTransactionRepository, JournalRepository, PacRepository, PostTransactionRepository, TransactionRepository}
import zio._
import zio.prelude.FlipOps

final class TransactionServiceImpl(pacRepo: PacRepository, ftrRepo: TransactionRepository, journalRepo: JournalRepository, repository4PostingTransaction:PostTransactionRepository) extends TransactionService {
...
object TransactionServiceImpl {
  val live: ZLayer[PacRepository with TransactionRepository with JournalRepository with PostTransactionRepository, RepositoryError, TransactionService] =
