...
trait RoleRepository:
  ...
  def listUserRoles(p: (Int, String)): ZIO[Any, RepositoryError, List[Role]]
  def userRights(p: (Int, String)):ZIO[Any, RepositoryError, List[UserRight]]
...
object RoleRepository:
    ...
    def listUserRoles(p: (Int, String)): ZIO[RoleRepository, RepositoryError, List[Role]] =
      ZIO.serviceWithZIO[RoleRepository](_.listUserRoles(p))
    def userRights(p: (Int, String)): ZIO[RoleRepository, RepositoryError, List[UserRight]] =
