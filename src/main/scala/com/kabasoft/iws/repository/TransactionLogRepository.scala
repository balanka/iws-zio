...
object TransactionLogRepository:
  ...
  def find4Period(fromPeriod: Int, toPeriod: Int, company: String): ZIO[TransactionLogRepository, RepositoryError, List[TransactionLog]] =
    ZIO.serviceWithZIO[TransactionLogRepository](_.find4Period(fromPeriod, toPeriod, company))
