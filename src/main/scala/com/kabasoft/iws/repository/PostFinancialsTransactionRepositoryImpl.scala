...
import com.kabasoft.iws.repository.Schema.{pacSchema, journal_Schema}
...
final class PostFinancialsTransactionRepositoryImpl(pool: ConnectionPool) extends PostFinancialsTransactionRepository with FinancialsTransactionTableDescription {
...
object PostFinancialsTransactionRepositoryImpl {

  val live: ZLayer[ConnectionPool, RepositoryError, PostFinancialsTransactionRepository] =
    ZLayer.fromFunction(new PostFinancialsTransactionRepositoryImpl(_))
}
