...
import com.kabasoft.iws.repository.Schema.{ftransactionDetailsSchema, ftransactionDetails_Schema, ftransactionSchema_, ftransactionxSchema}
import java.time.Instant

trait FinancialsTransactionTableDescription extends IWSTableDescriptionPostgres {
