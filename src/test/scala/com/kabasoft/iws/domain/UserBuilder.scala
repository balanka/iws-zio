...
object UserBuilder {
  ...
  val companyId ="1000"
  val modelid = ModelId.USER.modelid
  ...
  val userx = User(userId+1, userNamex, fname, lname, hash, phone , email, department, menu,  companyId, modelid)
