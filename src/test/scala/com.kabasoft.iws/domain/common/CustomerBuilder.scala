...
object CustomerBuilder {
  ...
  val customer1 = Customer(customerId1, "B Mady", "Bintou Mady Kaba","Bielefelder Str 1", "33615" , "Bielefeld", "NRW", "DE", "0521-471163",
      "0521-471164","xxx@domain.de", accountRecvId, incaccountId, "DE22480501610043719244_X", vataccountId,1000)
  val customer2 = Customer(customerId2, "KABA Soft GmbH", "KABA Soft GmbH", "Universitaet Str 2", "33615", "Bielefeld", "NRW", "DE",
