...
object AccountBuilder {
  ...
  val REV_ACC2 =  Account(raccountId2, "G.u.V Passiva","G.u.V Passiva", t, t, t, company, Account.MODELID, paccountId0, false, true, "EUR", zero,zero,zero,zero, Nil.toSet)
  ...
  val receivaccount =
    Account(accountRecvId, "Forderung", "Forderung", t, t, t, company, Account.MODELID, raccountId1, true, true, ccy, zero, zero, zero, zero, Nil.toSet)

  val liabilityAccount =
    Account(accountLiabId, "Verbindlichkeiten", "Verbindlichkeiten", t, t, t, company, Account.MODELID, paccountId2, true, true, ccy, zero, zero, zero, zero, Nil.toSet)

  val liabilityAccount1 =
    Account(accountLiabId1, "Verbindlichkeiten aus Steuer und Abgaben ", "Verbindlichkeiten aus Steuer und Abgaben", t, t, t, company, Account.MODELID, accountLiabId, true, true, ccy, zero, zero, zero, zero, Nil.toSet)
