...
object WebSpec2 extends ZIOSpecDefault with HttpAppTestExtensions { self =>
    ...
    def spec = suite("API test")(
      suite("API integration test")(
        ...
        , BankStatementRepositoryImpl.live, BankRepositoryImpl.live, AccountCacheImpl.live, AccountServiceImpl.live
